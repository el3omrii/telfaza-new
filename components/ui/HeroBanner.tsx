  ...
  return (
    ...
    <div className="mx-auto max-w-3xl py-16 sm:py-24 lg:py-32">
      ...
      <div className="text-center">
        <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl dark:text-white">Watch Free Live Arabic TV Channels Online</h1>
        <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8 dark:text-gray-400">Stream news, drama, sports, and movies' channels directly in your browser with no subscription required.</p>
