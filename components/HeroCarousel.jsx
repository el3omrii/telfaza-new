...
<div role="status" className="w-full px-12 animate-pulse">
    ...
    <div className="w-full">
        ...
        <div className="h-2 bg-neutral-500 rounded-full max-w-[440px] mb-4"></div>
        <div className="h-2 bg-neutral-500 rounded-full max-w-[460px] mb-4"></div>
        <div className="flex flex-row gap-4 max-w-sm mb-8">
          <div className="h-8 bg-neutral-500 rounded-sm w-16"></div>
          <div className="h-8 bg-neutral-500 rounded-sm w-16"></div>
          <div className="h-8 bg-neutral-500 rounded-sm w-16"></div>
        </div>
